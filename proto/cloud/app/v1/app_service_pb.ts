...
/**
 * @generated from message app.v1.GetLockStateRequest
 */
export class GetLockStateRequest extends Message<GetLockStateRequest> {
  ...
  static readonly typeName = "app.v1.GetLockStateRequest";
...
/**
 * @generated from message app.v1.GetLockStateResponse
 */
export class GetLockStateResponse extends Message<GetLockStateResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "app.v1.GetLockStateResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message app.v1.SetLockStateRequest
 */
export class SetLockStateRequest extends Message<SetLockStateRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "app.v1.SetLockStateRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message app.v1.SetLockStateResponse
 */
export class SetLockStateResponse extends Message<SetLockStateResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "app.v1.SetLockStateResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "locked", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
